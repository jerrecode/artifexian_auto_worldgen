...
class WorldPipeline:
    ...
    def _array_export(self, w: dict[str, Any]) -> dict[str, np.ndarray]:
        return {
            ...
            "stress_field": w["tectonics"].stress_field,
            "strain_field": w["tectonics"].strain_field,
            "crust_age_myr": w["tectonics"].crust_age_myr,
            "orogen_age_myr": w["tectonics"].orogen_age_myr,
            "paleo_convergence": w["tectonics"].paleo_convergence,
            "mountain_strength": w["terrain"].mountain_strength,
            "ruggedness": w["terrain"].ruggedness,
            ...
            "rock_code": w["geology"].rock_code, "bedrock_code": w["geology"].bedrock_code,
            "paleoshallow_sea": w["geology"].paleoshallow_sea,
